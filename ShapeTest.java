...
public class ShapeTest
{
	...
	{
		Shape rect = new Rectangle("Rectangle1", 3.2, 5.5);
		Assert.assertEquals("Rectangle area incorrect.", 17.6, rect.getArea(), 0.0001);
		Assert.assertEquals("Rectangle perimeter incorrect.", 17.4, rect.getPerimeter(), 0.0001);
	...
	{
		Shape tri = new EquilateralTriangle("Triangle1", 3.1);
		Assert.assertEquals("Triangle area incorrect.", 4.16125205, tri.getArea(), 0.0001);
		Assert.assertEquals("Triangle perimeter incorrect.", 9.3, tri.getPerimeter(), 0.0001);
	...
	{
		Shape trap = new Trapezoid("Trapezoid1", 3.0, 3.2, 4.2, 4.8);
		Assert.assertEquals("Trapezoid area incorrect.", 13.09045, trap.getArea(), 0.0001);
		Assert.assertEquals("Trapezoid perimeter incorrect.", 15.2, trap.getPerimeter(), 0.0001);
	...
	public void CircleTest()
	{
		...
		Assert.assertEquals("Circle perimeter incorrect.", 2 * Math.PI * 4.0, circ.getPerimeter(), 0.0001);
	...
	{
		Shape rect = new Rectangle("Rectangle1", 5.0, 4.5);
		Assert.assertEquals("Shape gives incorrect toString.", "Rectangle	 ID = Rectangle1	 area = 22.500	 perimeter = 19.000", rect.toString());
	}
	...
	public void ComparePerimeterTest()
	{
		...
		// test unequal perimeter and area:
        Shape sqr3 = new Square("S2", 4.0);
        Assert.assertEquals("ShapeAreaComparator gave incorrect ordering.", 1, sc.compare(sqr3, rect));
        Assert.assertEquals("ShapeAreaComparator gave incorrect ordering.", -1, sc.compare(rect, sqr3));
        Assert.assertFalse("ShapeAreaComparator incorrectly finds shapes equal.", sc.equals(sqr3, rect));
	}
    ...
    public void NaturalCompareTest()
    {
		...
		Assert.assertEquals("Shape compareTo gave incorrect ordering.", 1, rect.compareTo(rect2));
		Assert.assertEquals("Shape compareTo gave incorrect ordering.", -1, rect2.compareTo(rect));
		
		// test equal area, unequal perimeter:
		Shape squ = new Square("S1", 2.0);
		Assert.assertEquals("Shape compareTo gave incorrect ordering.", 1, rect2.compareTo(squ));
		Assert.assertEquals("Shape compareTo gave incorrect ordering.", -1, squ.compareTo(rect2));
		
		// test equal area, equal perimeter:
		Shape rect3 = new Rectangle("R3", 2.0, 2.0);
		Assert.assertEquals("Shape compareTo gave incorrect ordering.", 0, rect3.compareTo(squ));
    }
}
